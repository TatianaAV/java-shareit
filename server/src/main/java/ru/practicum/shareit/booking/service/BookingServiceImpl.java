...
public class BookingServiceImpl implements BookingService {
    ...
    @Override
    public BookingForUser getById(long bookingId, long userId) {
    ...
    @Transactional
    @Override
    public BookingForUser add(long bookerId, BookingDto booking) {
    ...
    @Transactional
    @Override
    public BookingForUser updateStatus(long bookingId, long userId, Boolean approved) {
