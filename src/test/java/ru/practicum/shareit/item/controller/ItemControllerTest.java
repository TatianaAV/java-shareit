...
class ItemControllerTest {
    ...
    void search() throws Exception {
        ...
        when(itemService.search(anyString(), anyInt()))
                .thenReturn(List.of());
    ...
    void getById() throws Exception {
        ...
        when(itemService.getById(anyLong(), anyInt()))
    ...
    void addComment() throws Exception {
        when(itemService.addComment(anyInt(), any(CommentCreate.class), anyLong()))
    ...
    void update() throws Exception {
        when(itemService.update(anyLong(), anyInt(), any(UpdateItemDto.class)))
