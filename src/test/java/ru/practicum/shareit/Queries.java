...
public interface Queries {
    String ADD_USER = "insert into users (email, name) values ('User1@email.com', 'User1')";
    String ADD_USER_2 = "insert into users (email, name) values ('User2@email.com', 'User2')";
    ...
    String CURRENT_BOOKING =
            "insert into bookings (finish, start, status, booker_id, item_id) " +
                    "values ('2024-12-19 00:34:04.000000', '2022-11-19 00:33:16.000000', 'APPROVED', 2, 1)";
    String REJECTED_BOOKING =
            "insert into bookings (finish, start, status, booker_id, item_id) " +
                    "values ('2021-12-19 00:34:28.000000', '2020-12-19 00:34:52.000000', 'REJECTED', 2, 1)";
    String WAITING_BOOKING =
            "insert into bookings (finish, start, status, booker_id, item_id) " +
                    "values ('2024-12-19 00:37:08.000000', '2024-12-19 00:36:51.000000', 'WAITING', 2, 1)";
